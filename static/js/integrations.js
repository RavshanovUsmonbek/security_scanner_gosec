...
>
    ...
    methods: {
        ...
        handleEdit(data) {
            console.debug('gosec editIntegration', data)
                ...
                response.json().then(
                    errorData => {
                        errorData.forEach(item => {
                            console.debug('gosec item error', item)
        ...
        initialState: () => ({
            ...
            pluginName: 'security_scanner_gosec',
...
register_component('gosecIntegration', gosecIntegration)
